...
namespace JuegoDeGestion_3
{
    ...
    {
        public Troop_Basic1() : base("Basic troop", 150, 20, 10, 5, 10)
        { }
    }
    internal class Troop_Advanced1 : Game_Troops
    {
        public Troop_Advanced1() : base("Basic troop", 150, 20, 10, 5, 30)
        { }
    }
    ...
    public class Game_Enemies
    {
        ...
        public Game_Enemies(string name, int HitPoints, int EnemyDamage, int EnemyNumberOfAttacks, int EnemyValue)
        {
            ID = Guid.NewGuid();
            Enemy_Name = name;
            Enemy_HitPoints = HitPoints;
            Enemy_HitPoints_Remaining = HitPoints;
            Enemy_Damage = EnemyDamage;
            Enemy_NumberOfAttacks = EnemyNumberOfAttacks;
            Enemy_CreationCost = EnemyValue;
    ...
    internal class Game_Building
    {
        ...
        public void Improve_Quality()
        {
            Building_Quality += 1;
        }
    }
    internal class Building_Main_Fortress : Game_Building
    {
        // Si pierdo todas las construcciones de este tipo, pierdo la partida
        public Building_Main_Fortress() : base("Main Fortress", 1000, 200) { }
    }
    internal class Building_Resource1Gathering : Game_Building
    {
        public Building_Resource1Gathering() : base("Wood Gathering", 500, 100) { }
    }
